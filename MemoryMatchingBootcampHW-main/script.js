...
function initGame() {
    ...
    // add all elems of symbols two times into cards array + randomize
    let cards = symbols.concat(symbols);
    shuffleArray(cards);

    // create cards for each symbol in cards array and add to gamebaord
...
function createCard(symbol) {
    ...
    // save card symbol in symbol field
...
function flipCard(card) {
    ...
    // if card is flipped, unflip it and remove symbol from card
